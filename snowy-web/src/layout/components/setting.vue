	...
	<div class="setting-drawer-index-content">
		<div class="scrollbar">
			...
			<a-form ref="form" class="text-right">
				...
				<!--				<a-form-item label="首页大屏">-->
				<!--					<a-switch :checked="homePageOpen" @change="toggleState('homePageOpen')" />-->
				<!--				</a-form-item>-->
				<!--				<a-form-item label="默认跳转到首页">-->
				<!--					<a-switch :checked="goToHomePage" @change="toggleState('goToHomePage')" />-->
				<!--				</a-form-item>-->
