	...
	<div class="option-change-container">
		<a-row v-if="type === 'option' || type === 'tab'" :gutter="8">
			<div class="option-change-box" v-for="(val, index) in value" :key="index">
				<a-col :span="9"><a-input v-model:value="val.label" placeholder="名称" /></a-col>
				<a-col :span="9"><a-input v-model:value="val.value" placeholder="值" /></a-col>
				<a-col :span="6"
		...
		<a-row v-if="type === 'rules'" :gutter="8">
			<span v-for="(val, index) in value" :key="index">
				<div class="option-change-box" v-if="index !== 0">
					<a-col :span="18"><a-input v-model:value="val.message" placeholder="提示信息" /></a-col>
					<a-col :span="18"><a-input v-model:value="val.pattern" placeholder="正则表达式pattern" /></a-col>
					<a-col :span="6"
						><div @click="handleDelete(index)" class="option-delete-box">
							<delete-outlined /></div
					></a-col>
			...
			<a-col :span="24" class="fd-mt-2"><a @click="handleAddRules">增加校验</a></a-col>
		</a-row>
