...
export const globalStore = defineStore({
	...
	state: () => ({
		...
		// 是否展示首页大屏
		homePageOpen: getCacheConfig('SNOWY_HOME_PAGE_OPEN'),
		// 是否默认跳转到首页大屏
		goToHomePage: getCacheConfig('SNOWY_GO_TO_HOME_PAGE'),
		// 主题
		...
		// 默认选中的模块
		normalSelectedModule: toolDataGet('SNOWY_MENU_MODULE_ID') || '',
		// 左侧菜单栏显示隐藏
		isLeftMenu: true,
	}),
	getters: {},
	actions: {
		...
		setNormalSelectedModule(key) {
			this.normalSelectedModule = key
		},
		setIsLeftMenu(key) {
			this.isLeftMenu = key
		}
