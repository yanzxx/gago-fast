<template>
	...
	>
		<a-form ref="formRef" :model="formData" :rules="formRules" layout="vertical">
			...
			<a-form-item label="排序:" name="sortCode" id="sortCode">
				<a-input-number style="width: 100%" v-model:value="formData.sortCode" :max="100" id="sortCode" />
			</a-form-item>
		</a-form>
		<template #footer>
...
<script setup>
	...
	// 打开抽屉
	const onOpen = (record) => {
		// reactiveData.categoryOptions = tool.dictList('MODULE_TYPE')
		visible = true
		formData.value = {
			sortCode: 99
		}
