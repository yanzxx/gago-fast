<template>
						...
						<template v-if="column.dataIndex === 'action'">
							...
							<a-dropdown>
								...
								<template #overlay>
									<a-menu>
										<a-menu-item>
											<a @click="GrantLoginTerminalFormRef.onOpen(record)">授权登录终端</a>
										</a-menu-item>
										<a-menu-item>
											<a @click="GrantResourceForm.onOpen(record)">授权资源</a>
										</a-menu-item>
										<a-menu-item>
											<a @click="GrantSpaResourceForm.onOpen(record)">授权单页</a>
										</a-menu-item>
										<a-menu-item>
	...
	<grantResourceForm ref="GrantResourceForm" @successful="grantFormSuccessFul" />
	<grantMobileResourceForm ref="GrantMobileResourceForm" @successful="table.refresh(true)" />
	<grantSpaResourceForm ref="GrantSpaResourceForm" @successful="table.refresh(true)"></grantSpaResourceForm>
	<grantPermissionForm ref="GrantPermissionForm" @successful="grantFormSuccessFul" />
	<GrantLoginTerminalForm ref="GrantLoginTerminalFormRef" @successful="table.refresh(true)"></GrantLoginTerminalForm>
...
import {Empty, message} from 'ant-design-vue'
	...
	import GrantLoginTerminalForm from './grantLoginTerminalForm.vue'
	import grantSpaResourceForm from './grantSpaResourceForm.vue'
	...
	const GrantLoginTerminalFormRef = ref()
	const GrantSpaResourceForm = ref()
	...
	// 刷新列表
	const grantFormSuccessFul = () => {
		table.value.refresh(true)
		// window.location.reload()
		message.success('修改配置成功，正在重新加载系统...')
