...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public void add(SysMenuAddParam sysMenuAddParam) {
        ...
        // 如果没有设置图标，给定默认图标
        if(StrUtil.isEmpty(sysMenuAddParam.getIcon())) {
            sysMenuAddParam.setIcon("pic-left-outlined");
        }
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public String addForGenMenu(String parentId, String className, String title, String module, String path) {
        // 参数校验
        ...
        sysMenu.setComponent(StrUtil.removePrefix(path, StrUtil.SLASH) + "Index");
    ...
    public void edit(SysMenuEditParam sysMenuEditParam) {
        ...
        // 如果没有设置图标，给定默认图标
        if(StrUtil.isEmpty(sysMenuEditParam.getIcon())) {
            sysMenuEditParam.setIcon("pic-left-outlined");
        }
