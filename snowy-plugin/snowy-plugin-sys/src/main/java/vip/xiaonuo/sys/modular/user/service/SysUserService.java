...
public interface SysUserService extends IService<SysUser> {
     ...
     * @date 2023/8/3 20:51
     */
    List<SysSpa> ownSpa(SysRoleIdParam sysRoleIdParam);
     ...
     */
    List<String> getMobileGlobalCodeList(List<String> userAndRoleIdList);
     ...
     **/
    List<SysUser> getAllUserSelectorList();
     ...
     */
    List<String> getDeviceByRoleIdList(List<String> roleIdList, String device);
     ...
     */
    SysUserPasswordExpireResult checkPasswordExpire();
}
