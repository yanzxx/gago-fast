<template>
  ...
  <div id="myChartBar" style="height: 300px; width: 100%; min-height: 100px;min-width: 100px;"></div>
  <div id="myChartLine" style="height: 300px; width: 100%; min-height: 100px;min-width: 100px;margin-top: 10px;"></div>
</template>
...
<script setup>
  ...
  const initBarDrawer = () => {
    const myChart = echarts.init(document.getElementById('myChartBar'))
    const option = {
